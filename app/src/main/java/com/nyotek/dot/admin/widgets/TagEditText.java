...
public class TagEditText extends androidx.appcompat.widget.AppCompatEditText {
    ...
    private void format(Context context) {
        ...
        for (int i = 0; i < strings.length; i++) {
            ...
            BitmapDrawable bd = (BitmapDrawable) convertViewToDrawable(createTokenView(string, context));
    ...
    public View createTokenView(String text, Context context) {
        ...
        tv.setPadding(2,2,10,2);
        Typeface typeface = ResourcesCompat.getFont(context, R.font.archivo_regular);
        ...
        l.addView(im);
        im.setImageResource(R.drawable.ic_close_tag);
        im.setScaleType(ImageView.ScaleType.FIT_CENTER);
        l.setGravity(Gravity.CENTER_VERTICAL);
        l.setPadding(10, 2, 10, 2);
    ...
    private class MyClickableSpan extends ClickableSpan {
        ...
        public void onClick(View widget) {
            ...
            String selectedTag = s.substring(startIdx, endIdx + 1);
