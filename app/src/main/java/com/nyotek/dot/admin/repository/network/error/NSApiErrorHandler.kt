...
class NSApiErrorHandler {
    companion object {
        ...
        const val ERROR_DISPATCH_REQUEST_DETAIL = "error_dispatch_request_detail"
        ...
        const val ERROR_VENDOR_DETAIL = "error_vendor_detail"
        const val ERROR_DOCUMENT_LIST = "error_document_list"
