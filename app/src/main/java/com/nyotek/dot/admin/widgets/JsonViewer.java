...
import com.paulvarry.jsonviewer.R;
        ...
        if (haveChild) {
            ...
            textViewHeader.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    textViewHeader.setTextColor(ColorResources.INSTANCE.getPrimaryColor());
...
//        content.setBackgroundTintList(ColorStateList.valueOf(Color.GREEN));
    ...
    private TextView getHeader(Object key, @Nullable Object jsonNode, boolean haveNext, boolean childDisplayed, boolean haveChild) {
        ...
        textView.setTextColor(ColorResources.INSTANCE.getPrimaryColor());
            ...
            if (jsonNode instanceof JSONArray) {
                ...
                if (Build.VERSION.SDK_INT >= 21) {
                    if (jsonNode instanceof String)
                        b.append("\"" + jsonNode + "\"", new ForegroundColorSpan(ColorResources.INSTANCE.getPrimaryColor()), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                    else if (jsonNode instanceof Integer || jsonNode instanceof Float || jsonNode instanceof Double)
                        b.append(jsonNode.toString(), new ForegroundColorSpan(ColorResources.INSTANCE.getPrimaryColor()), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
