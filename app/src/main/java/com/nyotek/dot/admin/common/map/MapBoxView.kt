package com.nyotek.dot.admin.common.map
...
import com.nyotek.dot.admin.common.BitmapUtils
...
import com.nyotek.dot.admin.models.responses.FeaturesItem
...
//                    }, 3000)
    ...
    private fun prepareViewAnnotation(feature: Feature?) {
        ...
        fun callDialogMap() {
            ...
            viewAnnotation?.layoutDirection = if(languageConfig.isLanguageRtl()) View.LAYOUT_DIRECTION_RTL else View.LAYOUT_DIRECTION_LTR
            ...
            InfoWindowMultilineBinding.bind(viewAnnotation!!).apply {
                ...
                layoutTime.tvValueMap.text = NSDateTimeHelper.formatDateToNowOrDateTime(timeValue, colorResources)
            }
        }
