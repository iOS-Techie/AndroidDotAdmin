...
android {
    ...
    productFlavors {
        create("development") {
            ...
            buildConfigField ("String", "TYPE", "\"0\"")
        ...
        create("production") {
            ...
            buildConfigField("String", "BASE_URL_DEBUG", "\"https://dev.hubz.nyotek.com/\"")
            buildConfigField("String", "BASE_URL_THEME", "\"http://34.91.213.39:6080/\"")
            buildConfigField("String", "BASE_URL_LOCATION", "\"https://prod.hubz.nyotek.com/\"")
            buildConfigField("String", "BASE_URL_FLEET", "\"https://prod.hubz.nyotek.com/\"")
